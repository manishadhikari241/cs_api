...
<div>
    <p>
        @lang('emails.projects.request.applied.message', ['name' => $request->studio->translations[0]->name])
    </p>

    <p>@lang('emails.package.selected')</p>
    ...
    <p>@lang('emails.projects.request.applied.guarantee', ['price' => $request->projectPackage->price])</p>

    {{-- <br>
    <table width="215">
      <tr><td width="215" style="text-align: center;padding: 10px 0;background: #717171;">
        <a href="{{ url('/premium/projects') }}" target="_blank" style="text-decoration: none; display: block; font-family: Arial, 'Times New Roman', sans-serif; font-size: 16px; line-height: 18px; width: 215px;  text-align: center; color: #fff; background-color: #717171; -webkit-border-radius: 3px; border-radius: 3px; display: inline-block;">
            Continue
        </a>
      </td></tr>
    </table>
